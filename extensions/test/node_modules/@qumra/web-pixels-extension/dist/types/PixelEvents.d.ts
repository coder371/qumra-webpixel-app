...
export interface PixelEventsCartUpdated {
    name: 'cart_updated';
    data: Data;
    timestamp: number;
}
...
export interface PixelEvents {
    ...
    cart_updated: PixelEventsCartUpdated;
